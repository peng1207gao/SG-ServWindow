package com.sgcc.dlsc.contractManage.settleaccountsassist.vo;
 ...
 *
 * @author  Jingbo.Fu  [Mon Feb 17 15:58:51 CST 2014]
 * 
 */
public class CoContractbaseinfoVO extends ParentVO implements Serializable{
     ...
     * 属性supercontractid
     */
	@ViewAttribute(name = "supercontractid", caption="主合同编号", length =36, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.STRING) 
     ...
     * 属性signeddate
     */
	@ViewAttribute(name = "signeddate", caption="备案状态", length =2, editor=EditorType.DateTimeEditor,  nullable=true, readOnly=false,  type=AttributeType.DATE) 
     ...
     * 属性contractcyc
     */
	@ViewAttribute(name = "contractcyc", caption="合同类型", length =2, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
	private BigDecimal contractcyc;
    /** 
     * 属性purchaser
     */
	@ViewAttribute(name = "purchaser", caption="购电主体", length =36, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.STRING) 
	private String purchaser;
    /** 
     * 属性seller
     */
	@ViewAttribute(name = "seller", caption="合同开始时间", length =36, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.STRING) 
	private String seller;
    /** 
     * 属性sellerunit
     */
	@ViewAttribute(name = "sellerunit", caption="售电方", length =36, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.STRING) 
	private String sellerunit;
    /** 
     * 属性purchaseunit
     */
	@ViewAttribute(name = "purchaseunit", caption="购电方", length =36, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.STRING) 
	private String purchaseunit;
    /** 
     * 属性contractqty
     */
	@ViewAttribute(name = "contractqty", caption="交易性质", length =16, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
	private BigDecimal contractqty;
    /** 
     * 属性qtytype
     */
	@ViewAttribute(name = "qtytype", caption="发电权结算方", length =2, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
	private BigDecimal qtytype;
    /** 
     * 属性contractstartdate
     */
	@ViewAttribute(name = "contractstartdate", caption="开始时间", length =2, editor=EditorType.DateTimeEditor,  nullable=true, readOnly=false,  type=AttributeType.DATE) 
	private Date contractstartdate;
    /** 
     * 属性contractenddate
     */
	@ViewAttribute(name = "contractenddate", caption="结束时间", length =2, editor=EditorType.DateTimeEditor,  nullable=true, readOnly=false,  type=AttributeType.DATE) 
     ...
     * 属性sequenceid
     */
	@ViewAttribute(name = "sequenceid", caption="序列id", length =36, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.STRING) 
	private String sequenceid;
    /** 
     * 属性energy
     */
	@ViewAttribute(name = "energy", caption="电量", length =12, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
     ...
     * 属性contractenergy
     */
	@ViewAttribute(name = "contractenergy", caption="总电量", length =12, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
     ...
     * 属性expend1
     */
	@ViewAttribute(name = "expend1", caption="扩展1", length =12, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
	private BigDecimal expend1;
    /** 
     * 属性expend2
     */
	@ViewAttribute(name = "expend2", caption="扩展2", length =12, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
	private BigDecimal expend2;
    /** 
     * 属性expend3
     */
	@ViewAttribute(name = "expend3", caption="扩展3", length =12, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
	private BigDecimal expend3;
    /** 
     * 属性expend4
     */
	@ViewAttribute(name = "expend4", caption="扩展4", length =12, editor=EditorType.DateTimeEditor,  nullable=true, readOnly=false,  type=AttributeType.DATE) 
	private Date expend4;
    /** 
     * 属性expend5
     */
	@ViewAttribute(name = "expend5", caption="扩展5", length =32, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.STRING) 
	private String expend5;
    /** 
     * 属性expend6
     */
	@ViewAttribute(name = "expend6", caption="扩展6", length =32, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.STRING) 
     ...
     * 属性sellergen
     */
	@ViewAttribute(name = "sellergen", caption="售电方发电量", length =12, editor=EditorType.TextEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
