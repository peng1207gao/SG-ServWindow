package com.sgcc.dlsc.contractManage.cocontractbaseInfoV2.vo;
 ...
 *
 * @author  xiabaike  [Sat Feb 15 16:31:28 CST 2014]
 * 
 */
public class CoContractbaseinfoVO extends ParentVO implements Serializable{
     ...
     * 属性expend3
     */
	@ViewAttribute(name = "expend3", caption="??3", length =12, editor=EditorType.DateTimeEditor,  nullable=true, readOnly=false,  type=AttributeType.BIGDECIMAL) 
