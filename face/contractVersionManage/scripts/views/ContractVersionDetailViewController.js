...
contractVersionManage.views.ContractVersionDetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new contractVersionManage.views.ContractVersionDetailView({controller: me, alias:"contractVersionManageContractVersionDetailView"});
        }
        return me.view;
    };
