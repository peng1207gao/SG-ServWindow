...
//$import("contractrecordinformation.views.ContractRecordInformationDetailView");

contractrecordinformation.views.ContractRecordInformationDetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new contractrecordinformation.views.ContractRecordInformationDetailView({controller: me, alias:"contractrecordinformationContractRecordInformationDetailView"});
        }
        return me.view;
    };
