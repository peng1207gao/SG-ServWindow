...
contractrecordinformation.views.ContractRecordInformationMainViewController = function()
{
...
//        if (me.view == null)
//        {
//            me.view = new contractrecordinformation.views.ContractRecordInformationMainView({ controller: me });
//        }
//        return me.view;
//    };
    me.getView = function(e)
    {
        if (me.view == null)
        {
        	...
        	e.controller = me;
            me.view = new contractrecordinformation.views.ContractRecordInformationMainView(e);
        }
        return me.view;
    };
    /**
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new contractrecordinformation.views.ContractRecordInformationDetailViewController();
    ...
    {        
    	...
    	//_detailView.param = me.getView().param;
	    //显示详细信息页面
