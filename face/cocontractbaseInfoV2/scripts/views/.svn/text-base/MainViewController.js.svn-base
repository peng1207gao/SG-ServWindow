...
cocontractbaseInfoV2.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new cocontractbaseInfoV2.views.MainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new cocontractbaseInfoV2.views.DetailViewController();
