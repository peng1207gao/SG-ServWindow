...
cocontractbaseInfoV2.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new cocontractbaseInfoV2.views.DetailView({controller: me, alias:"cocontractbaseInfoV2DetailView"});
        }
        return me.view;
    };
