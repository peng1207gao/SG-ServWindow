...
cocontractbaseInfoV2.views.DetailView = function()
{
    ...
    function _initToolBar()
    {
    	_toolBar = new mx.controls.ToolBar({
            alias:"cocontractbaseInfoV2DetailViewToolBar",
            width: "100%"
        });
        var btnSave = _toolBar.appendItem("save", mx.msg("SAVE"));
        btnSave.alias = "cocontractbaseInfoV2DetailViewBtnSave";
    ...
    function _initDataForm()
    {
        ...
        _form = new mx.datacontrols.DataForm({
			...
			alias:"cocontractbaseInfoV2DetailViewDataForm",
