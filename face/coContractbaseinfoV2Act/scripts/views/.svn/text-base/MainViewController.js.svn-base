...
coContractbaseinfoV2Act.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new coContractbaseinfoV2Act.views.MainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new coContractbaseinfoV2Act.views.DetailViewController();
