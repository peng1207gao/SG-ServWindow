...
coContractbaseinfoV2Act.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new coContractbaseinfoV2Act.views.DetailView({controller: me, alias:"coContractbaseinfoV2ActDetailView"});
        }
        return me.view;
    };
