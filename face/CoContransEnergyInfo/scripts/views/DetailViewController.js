...
CoContransEnergyInfo.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new CoContransEnergyInfo.views.DetailView({controller: me, alias:"CoContransEnergyInfoDetailView"});
        }
        return me.view;
    };
