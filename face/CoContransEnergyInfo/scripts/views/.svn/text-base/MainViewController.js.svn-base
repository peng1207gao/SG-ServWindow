...
CoContransEnergyInfo.views.MainViewController = function()
{
...
//        if (me.view == null)
//        {
//            me.view = new CoContransEnergyInfo.views.MainView({ controller: me });
//        }
//        return me.view;
//    };
    ...
    me.getView = function(e)
    {
        if (me.view == null)
        {
        	...
        	e.controller = me;
            me.view = new CoContransEnergyInfo.views.MainView(e);
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new CoContransEnergyInfo.views.DetailViewController();
    ...
    me._btnNew_onclick = function()
    {
        ...
        _detailView.contractId = me.objId;//me.contractId;
        _detailView.contractName = me.objName;//me.contractName;
        _showDetailFormView(_detailView,"合同输电方列表");
    };
