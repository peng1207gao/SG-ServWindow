...
$import("jfcontractstate.views.JfContractStateDetailView");

jfcontractstate.views.JfContractStateDetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new jfcontractstate.views.JfContractStateDetailView({controller: me, alias:"jfcontractstateJfContractStateDetailView"});
        }
        return me.view;
    };
