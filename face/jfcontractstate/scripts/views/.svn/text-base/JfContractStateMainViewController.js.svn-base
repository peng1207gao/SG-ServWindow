...
jfcontractstate.views.JfContractStateMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new jfcontractstate.views.JfContractStateMainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new jfcontractstate.views.JfContractStateDetailViewController();
