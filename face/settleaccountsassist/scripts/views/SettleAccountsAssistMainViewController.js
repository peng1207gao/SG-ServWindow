...
//$import("settleaccountsassist.views.SettleAccountsAssistDetailViewController");
//$import("settleaccountsassist.views.SettleAccountsAssistMainView");

settleaccountsassist.views.SettleAccountsAssistMainViewController = function()
{
    ...
    var _resolveElecticView = null;
    
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new settleaccountsassist.views.SettleAccountsAssistMainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new settleaccountsassist.views.SettleAccountsAssistDetailViewController();
     ...
     * 获取分解电量到经济机组视图对象
     */
    me._getResolveElectricView = function(){
    	if (_resolveElecticView == null)
        {
            var mvc = new resolveelectricquantitytounit.views.ResolveElectricQuantityToUnitMainViewController();
            _resolveElecticView = mvc.getView();
        }
    	return _resolveElecticView;
    }
...
//	    me.view.getDataGrid().load();
    ...
    me._showResolveElectricView = function(){
    	var v_dataGrid = me.view.getDataGrid();
    	if (v_dataGrid.getCheckedIDs().length == 0)
        {
             mx.indicate("info", "请勾选一条待编辑记录。");
    	...
    	var _resolveElecticView = me._getResolveElectricView();
    	_resolveElecticView.contractids = v_dataGrid.getCheckedIDs();
	    //显示详细信息页面
    	_showDetailFormView(_resolveElecticView,"分解电量到经济机组");
    }
