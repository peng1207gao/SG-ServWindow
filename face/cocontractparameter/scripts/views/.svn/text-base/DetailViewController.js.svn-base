...
cocontractparameter.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new cocontractparameter.views.DetailView({controller: me, alias:"cocontractparameterDetailView"});
        }
        return me.view;
    };
