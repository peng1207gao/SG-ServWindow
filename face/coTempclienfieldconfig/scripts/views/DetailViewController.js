...
coTempclienfieldconfig.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new coTempclienfieldconfig.views.DetailView({controller: me, alias:"coTempclienfieldconfigDetailView"});
        }
        return me.view;
    };
