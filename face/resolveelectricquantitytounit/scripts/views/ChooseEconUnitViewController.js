...
resolveelectricquantitytounit.views.ChooseEconUnitViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new resolveelectricquantitytounit.views.ChooseEconUnitView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new resolveelectricquantitytounit.views.ChooseEconUnitViewController();
