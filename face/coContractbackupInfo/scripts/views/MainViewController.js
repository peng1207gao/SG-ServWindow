...
coContractbackupInfo.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new coContractbackupInfo.views.SdfMainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new coContractbackupInfo.views.DetailViewController();
    ...
    me._btnNew_onclick = function()
    {
        ...
        _detailView.contractId = "4028804a3d4cc6df013d4d18dc220004";//me.contractId;
        _detailView.contractName = "内蒙古国电";//me.contractName;
