...
coContractbackupInfo.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new coContractbackupInfo.views.DetailView({controller: me, alias:"coContractbackupInfoDetailView"});
        }
        return me.view;
    };
