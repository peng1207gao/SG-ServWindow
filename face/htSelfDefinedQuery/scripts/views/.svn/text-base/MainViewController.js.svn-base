...
htSelfDefinedQuery.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new htSelfDefinedQuery.views.MainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new htSelfDefinedQuery.views.DetailViewController();
