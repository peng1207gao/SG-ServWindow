...
CoContractchangerecordinfo.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new CoContractchangerecordinfo.views.DetailView({controller: me, alias:"CoContractchangerecordinfoDetailView"});
        }
        return me.view;
    };
