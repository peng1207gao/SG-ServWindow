...
coContractgateinfo.views.DetailViewController1 = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
//            me.view = new coContractgateinfo.views.DetailView({controller: me, alias:"coContractgateinfoDetailView"});
            me.view = new coContractgateinfo.views.DetailView1({controller: me, alias:"coContractgateinfoDetailView1"});
        }
        return me.view;
    };
