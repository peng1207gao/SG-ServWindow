...
kqksexetrace.views.KqKsExeTraceSellerView = function()
{
    ...
    me._initParams = function(){
    	var params = {papercontractname:me.lineName.value,signeddate:me.startTime.value,backupdate:me.endTime.value,expend5:"sell"};
    	return params;
    }
    
    me._initParams1 = function(){
    	var params = {"lineName":me.lineName.value,"startTime":me.startTime.value,"endTime":me.endTime.value,"type":"sell"};
    	return params;
    }
