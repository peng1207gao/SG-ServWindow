...
kqksexetrace.views.KqKsExeTraceDetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new kqksexetrace.views.KqKsExeTraceDetailView({controller: me, alias:"kqksexetraceKqKsExeTraceDetailView"});
        }
        return me.view;
    };
