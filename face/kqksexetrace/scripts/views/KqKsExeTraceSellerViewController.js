...
kqksexetrace.views.KqKsExeTraceSellerViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new kqksexetrace.views.KqKsExeTraceSellerView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new kqksexetrace.views.KqKsExeTraceDetailViewController();
     ...
     * 显示图表
     */
    me._btn_Display = function(){
//    	me.view.container5.setPadding("2px");
//    	me.view.container5.setHeight(500);
    	var restClient = new mx.rpc.RESTClient();
    	var responseContent = restClient.getSync(kqksexetrace.mappath(
    		"~/rest/cocontractbaseinfo_mk/getDataChart"), { "params": JSON.stringify(me.view._initParams1())});
    	if(responseContent.successful == true){
	    	...
	    	me.view.container5.addControl(chart);
	    	chart.render(me.view.container5.$e.get(0));
    	}
    }
