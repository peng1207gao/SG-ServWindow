...
CoContractbaseInfo.views.DetailView = function()
{
    ...
    function _initToolBar()
    {
    	_toolBar = new mx.controls.ToolBar({
            alias:"CoContractbaseInfoDetailViewToolBar",
            width: "100%"
        });
        var btnSave = _toolBar.appendItem("save", mx.msg("SAVE"));
        btnSave.alias = "CoContractbaseInfoDetailViewBtnSave";
    ...
    function _initDataForm()
    {
        ...
        _form = new mx.datacontrols.DataForm({
			...
			alias:"CoContractbaseInfoDetailViewDataForm",
