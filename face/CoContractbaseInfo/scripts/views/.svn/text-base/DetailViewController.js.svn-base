...
CoContractbaseInfo.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new CoContractbaseInfo.views.DetailView({controller: me, alias:"CoContractbaseInfoDetailView"});
        }
        return me.view;
    };
