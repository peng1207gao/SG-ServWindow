...
co_contractChangeRecordInfo.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new co_contractChangeRecordInfo.views.DetailView({controller: me, alias:"co_contractChangeRecordInfoDetailView"});
        }
        return me.view;
    };
