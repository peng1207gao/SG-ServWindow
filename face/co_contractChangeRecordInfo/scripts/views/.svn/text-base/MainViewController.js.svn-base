...
co_contractChangeRecordInfo.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new co_contractChangeRecordInfo.views.MainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new co_contractChangeRecordInfo.views.DetailViewController();
