...
CoContractFjAct.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new CoContractFjAct.views.MainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new CoContractFjAct.views.DetailViewController();
