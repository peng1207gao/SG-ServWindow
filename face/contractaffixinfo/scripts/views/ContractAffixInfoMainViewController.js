...
contractaffixinfo.views.ContractAffixInfoMainViewController = function()
{
...
//        if (me.view == null)
//        {
//            me.view = new contractaffixinfo.views.ContractAffixInfoMainView({ controller: me });
//        }
//        return me.view;
//    };
    me.getView = function(e)
    {
    	if (me.view == null)
    	{
        	...
        	e.controller = me;
        	me.view = new contractaffixinfo.views.ContractAffixInfoMainView(e);
    	}
    	return me.view;
    }
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new contractaffixinfo.views.ContractAffixInfoDetailViewController({winView:me.getView().getDetailWindow()});
     ...
     * 文本上传
     */
    me._btnUpload_onclick = function()
    {
    	var _detailView = me._getDetailFromView();
	    //设置对象id
        _detailView.objID = me.getView().contractid;
        _showDetailFormView(_detailView,"文本上传");
    }
