...
tempfieldconfig.views.TempfieldConfigDetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new tempfieldconfig.views.TempfieldConfigDetailView({controller: me, alias:"tempfieldconfigTempfieldConfigDetailView"});
        }
        return me.view;
    };
