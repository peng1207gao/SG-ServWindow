...
$import("CoContractparamdic.views.DetailViewController");
$import("CoContractparamdic.views.MainView");

CoContractparamdic.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new CoContractparamdic.views.MainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new CoContractparamdic.views.DetailViewController({co:me.view});
