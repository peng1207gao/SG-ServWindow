...
coContemplatewithparam.views.MainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new coContemplatewithparam.views.MainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new coContemplatewithparam.views.DetailViewController();
    ...
    me._DownButton_onclick = function(){
    	...
    	var filename = v_dataGrid;
    	window.open(coContemplatewithparam.mappath("~/rest/cocontemplatewithparam/down?guid="+guid));
    }
