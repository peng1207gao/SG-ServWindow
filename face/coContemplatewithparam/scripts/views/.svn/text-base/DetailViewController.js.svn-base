...
coContemplatewithparam.views.DetailViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new coContemplatewithparam.views.DetailView({controller: me, alias:"coContemplatewithparamDetailView"});
        }
        return me.view;
    };
