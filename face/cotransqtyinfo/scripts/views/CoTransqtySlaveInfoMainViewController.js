...
cotransqtyinfo.views.CoTransqtySlaveInfoMainViewController = function()
{
    ...
    me.getView = function()
    {
        if (me.view == null)
        {
            me.view = new cotransqtyinfo.views.CoTransqtySlaveInfoMainView({ controller: me });
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new cotransqtyinfo.views.CoTransqtySlaveInfoDetailViewController({objID:me.objId});
