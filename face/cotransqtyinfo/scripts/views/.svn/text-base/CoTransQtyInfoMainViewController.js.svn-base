...
cotransqtyinfo.views.CoTransQtyInfoMainViewController = function()
{
...
//        if (me.view == null)
//        {
//            me.view = new cotransqtyinfo.views.CoTransQtyInfoMainView({ controller: me });
//        }
//        return me.view;
//    };
    me.getView = function(e)
    {
        if (me.view == null)
        {
        	...
        	e.controller = me;
            me.view = new cotransqtyinfo.views.CoTransQtyInfoMainView(e);
        }
        return me.view;
    };
    /**
    ...
    me._getDetailFromView = function(){
            ...
            var mvc = new cotransqtyinfo.views.CoTransQtyInfoDetailViewController({mainCo:me});
...
//		me.view.getDetailWindow().hide();
		_detailView.getDataGrid().setFilter({transinfoid:_detailView.getForm().entityContainer.data.transinfoid});
    	me.view.getDataGrid().load();
	}
...
//        alert(_detailView.coType);
    ...
    me._btnEdit_onclick = function()
    {
    	...
    	me.uuid = v_dataGrid.getCheckedIDs()[0];
    	var _detailView = me._getDetailFromView();
...
//    	var win = me.view.getDetailWindow();
    	var win = utils.commonFun.WinMananger.create({
			reusable: true,//是否复用
			width:640,
			height:480,
			title:"表单维护",
			onshown:function(){
				p_view._initLeftChart();
			}
		});
