...
CoContransEnergyInfoV2.views.MainViewController = function()
{
...
//        if (me.view == null)
//        {
//            me.view = new CoContransEnergyInfoV2.views.MainView({ controller: me });
//        }
//        return me.view;
//    };
    ...
    me.getView = function(e)
    {
        if (me.view == null)
        {
        	...
        	e.controller = me;
            me.view = new CoContransEnergyInfoV2.views.MainView(e);
        }
        return me.view;
    };
    ...
    me._getDetailFromView = function(){
    	if (_detailView == null)
        {
            var mvc = new CoContransEnergyInfoV2.views.DetailViewController();
    ...
    me._btnNew_onclick = function()
    {
        ...
        _detailView.contractid = me.contractid;
        _showDetailFormView(_detailView,"输电费及网损信息新增");
    };
    ...
    {        
	    ...
	    //显示详细信息页面
    	_showDetailFormView(_detailView,"输电费及网损信息编辑");
    };
